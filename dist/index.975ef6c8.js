...
let tipPercentageSubject = new (0, _rxjs.BehaviorSubject)(tipPercentage);
let billSubject = new (0, _rxjs.BehaviorSubject)(bill);
let numberOfPeopleSubject = new (0, _rxjs.BehaviorSubject)(numberOfPeople);
let buttonIndexSubject = new (0, _rxjs.BehaviorSubject)(buttonIndex);
(0, _rxjs.fromEvent)(document.getElementById("billInput"), "input").pipe((0, _rxjs.debounceTime)(400)).subscribe((event)=>billSubject.next(Number(event.target.value)));
(0, _rxjs.fromEvent)(document.getElementById("numPeopleInput"), "input").pipe((0, _rxjs.debounceTime)(400), (0, _rxjs.filter)((inputEvent)=>inputEvent.target.value > 0 === true)).subscribe((event)=>numberOfPeopleSubject.next(Number(event.target.value)));
tipAmounts.forEach((tip, index)=>{
    tipButtons[index].innerHTML = `${tip * 100}%`;
    (0, _rxjs.fromEvent)(tipButtons[index], "click").subscribe(()=>{
...
(0, _rxjs.fromEvent)(tipButtons[5], "click").subscribe(()=>{
...
let tipAmount = (0, _rxjs.combineLatest)([
...
(0, _rxjs.fromEvent)(document.getElementById("reset"), "click").subscribe(()=>{
    billSubject.next(0);
...
},{"../observable/innerFrom":"27e4p","../util/executeSchedule":"lF0MM","./OperatorSubscriber":"96z9b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kQLcN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../scheduler/async":"bKyC1","../util/lift":"7CiSs","./OperatorSubscriber":"96z9b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gA0i5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../util/lift":"7CiSs","./OperatorSubscriber":"96z9b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["igKGj","8lqZg"], "8lqZg", "parcelRequire56c1")
